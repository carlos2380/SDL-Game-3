...
bool ModuleSceneSpace::Start()
{
	...
	App->collision->AddCollider(SDL_Rect({ 0, 224, 3930, 16 }), WALL);
	App->collision->AddCollider(SDL_Rect({ 1375, 0, 111, 96 }), WALL);
	App->collision->AddCollider(SDL_Rect({ 1375, 145, 111, 96 }), WALL);
	return true;
}
